...
const LOCALES = {
  ...
  "dashboard.subtitle": "Your automation stats at a glance",
  ...
  "wa.sending": "Sending…",
  "wa.connect_title": "Connect WhatsApp",
  ...
  "chatbot.placeholder": "Ask AutoFlow AI…",
  "chatbot.send": "Send ▶",
              ...
              <div key={i}>
                ...
                <ol style={{paddingLeft:16}}>
                  {section.steps.map((step,j) => (
                    <li key={j} style={{fontSize:12,color:C.muted,marginBottom:4,lineHeight:1.6,
